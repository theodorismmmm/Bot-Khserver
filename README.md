...
- `GRANT_MANAGER_USER_IDS` (optional comma-separated Discord user IDs that can also use `/grant` and `/removegrant`; if unset, it defaults to `1020796397764747287`; for production, explicitly set this value)
